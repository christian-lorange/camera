var app = {
  startCameraAbove: function(){
    CameraPreview.startCamera({x: 0, y: 0, toBack: false, previewDrag: true, tapPhoto: true});
  },

  startCameraBelow: function(){
    CameraPreview.startCamera({x: 0, y: 0, camera: "front", tapPhoto: true, previewDrag: false, toBack: true});
  },
